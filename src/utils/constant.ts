export const DEFAULT_ERROR = "Ooops something went wrong!";
export const FILE_TYPE_ERROR = "file type not support!";
export const FILE_SIZE_ERROR = "file size too big or too small!";

export const MESSAGE_TIME_FORMAT = "DD MMM, HH:MM";

export const IMAGES_TYPE = ["image/png", "image/jpg", "image/jpeg", "image/webp"];
...
export const RATE_DESC = ['terrible', 'bad', 'normal', 'good', 'wonderful'];
